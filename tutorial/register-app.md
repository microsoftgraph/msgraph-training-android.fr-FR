...
1. Choisissez **Inscrire**. Sur la page **didacticiel Graph Android** , copiez la valeur de l' **ID d'application (client)** et enregistrez-la, vous en aurez besoin à l'étape suivante.
